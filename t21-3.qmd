...
## I. Сходимость функциональных рядов

### Задание 1. Найти радиус, интервал и область сходимости степенного ряда:
...
$${{( 1+x )}^{\alpha }}=1+\frac{\alpha }{1!}x+\frac{\alpha ~( \alpha -1 )}{2!}{{x}^{2}}+\ldots +\frac{\alpha ~( \alpha -1 )\ldots ( \alpha -n+1 )}{n!}{{x}^{n}}+\ldots $$
...
## $\ln(1+\frac{x}3)$
**Решение.**
Так как $\ln ( 1+x )=x-\frac{{{x}^{2}}}{2}+\frac{{{x}^{3}}}{3}-\ldots +\frac{{{( -1 )}^{n-1}}{{x}^{n}}}{n}+\ldots $ при $x\in ( -1;1 )$, то вместо $x$ в эту формулу будем подставлять $\frac{x}{3}$:
4.		$f( x )=\ln ( 1+\frac{x}{3} )=\frac{x}{3}-\frac{{{( \frac{x}{3} )}^{2}}}{2}+\frac{{{( \frac{x}{3} )}^{3}}}{3}-\ldots +\frac{{{( -1 )}^{n-1}}{{( \frac{x}{3} )}^{n}}}{n}+\ldots =$
 $=\frac{x}{3}-\frac{{{x}^{2}}}{18}+\frac{{{x}^{3}}}{81}-\ldots +\frac{{{( -1 )}^{n-1}}{{x}^{n}}}{{{( 3 )}^{n}}n}+\ldots ,~~$   $-1<x\le 1$ ; $-3<\frac{x}{3}\le 3$. 
...
## 24
$$\marhrm{arctg}\left(\frac{3x}{2}\right)$$
